...
ALTER TABLE students ADD COLUMN IF NOT EXISTS fees_25_26 DECIMAL(10,2) DEFAULT 0;
ALTER TABLE students ADD COLUMN IF NOT EXISTS fees_paid_25_26 DECIMAL(10,2) DEFAULT 0;

-- Add 2026-27 year fees (CURRENT YEAR from client file)
ALTER TABLE students ADD COLUMN IF NOT EXISTS fees_26_27 DECIMAL(10,2) DEFAULT 0;
ALTER TABLE students ADD COLUMN IF NOT EXISTS fees_paid_26_27 DECIMAL(10,2) DEFAULT 0;
